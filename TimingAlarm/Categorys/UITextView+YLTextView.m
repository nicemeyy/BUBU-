...
- (UIFont *)placeholdFont {
    return objc_getAssociatedObject(self, &PLACEHOLDFONT) == nil ? [UIFont systemFontOfSize:17.] : objc_getAssociatedObject(self, &PLACEHOLDFONT);
}
...
- (void)setPlaceHolderLabel:(NSString *)placeholder {
    ...
    self.wordCountLabel.text = [NSString stringWithFormat:@"%@",self.limitLength];
